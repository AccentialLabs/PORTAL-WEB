...
{
public $link_class    = 'crumb_link'    ;    // css class for anchor tags.
public $span_class    = 'crumb_span'    ;    // css class for the span element .(last label).
public $separator    = ' > '            ;    // separator between links.
public $protocol    = 'http'            ;
public $helpers     = Array("Session");

public function addThisPage($title = null, $what_to_do = null , $level = null )    // add the calling page
{
    ...
    if ($what_to_do == 'reset' )    { // add this argument if it comes from menu.
    	unset($_SESSION['crumb_links']);
    	unset($_SESSION['crumb_titles']);
    	unset($_SESSION['crumb_levels']);
 ...
 */
public function getHtml($title = null, $what_to_do=null, $level = null)
{
...
public function __stripAfter($arr, $after)
{
    $count = count($arr)    ;
