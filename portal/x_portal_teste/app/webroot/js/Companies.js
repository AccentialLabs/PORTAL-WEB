$(function(){   
// $('.chama-compartilhar-oferta').click(function(){return false;})
...
//});
	...
	$('.abriropcoesusuario span').prepend('<img src="img/icones/arrow-usuario-logado.png">');
...
//$(this).parent().slideUp();
	...
	$('.linkpopup').click(function(){
		...
		$('.bg_popup').show();
		var altura = ($('.bg_popup').height() / 5) - $('.popup').height() /2;
...
$('#selecione-o-meio a').click(function(){
